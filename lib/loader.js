...
function Loader(Widget, options) {
  ...
  var currentScript = options.parent || document.currentScript;
  require('domready')(function () {
    ...
    var configData;
    try {
      configData = currentScript.innerText.trim() ? JSON.parse(currentScript.innerText) : {};
    ...
    widget.view.appendTo(currentScript.parentNode || document.querySelector('body'));
